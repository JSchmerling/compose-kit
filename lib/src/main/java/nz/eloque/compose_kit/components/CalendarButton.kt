...
fun CalendarButton(
    ...
    IconButton(onClick = {
        ...
        try {
            ...
            scope.launch {
                snackbarHostState.showSnackbar(message = resources.getString(R.string.compose_kit_no_calendar_app_found))
            }
        }
    }, modifier = modifier) {
        Icon(imageVector = Icons.Default.CalendarToday, contentDescription = stringResource(R.string.compose_kit_date))
    }
}
